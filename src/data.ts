...
export const featuredProducts: Products = [
  {
    id: 1,
    title: "Pizza de Pepperodnni",
    desc: "Pase por la pizzería y disfrute de una deliciosa pizza de pepperoni con queso derretido y una base de salsa de tomate.",
  ...
  },
  {
    ...
    desc: "Disfrute de la bondad ahumada con una jugosa hamburguesa de carne a la parrilla, cubierta con tocino crujiente, queso cheddar derretido, cebollas caramelizadas y una pizca de salsa BBQ picante.",
